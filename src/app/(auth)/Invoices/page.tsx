  ...
  <div className="min-h-screen bg-[#f5f7fb] p-2 md:p-2">
    ...
    <div className="flex flex-col gap-4 mt-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <SummaryCard label="Total Invoices" value={allInvoices.length} subtleLabel="All statuses" borderColor="#1392d3" />
    ...
    <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-x-auto mt-5">
      ...
      <div className="min-w-[900px]">
        ...
        <div className="grid grid-cols-8 gap-x-8 text-xs font-semibold text-gray-500 px-5 py-2 border-b bg-[#f9fafc]">
        ...
        {paginatedData.map((inv, i) => {
          ...
          return (
            <div
              key={inv.id}
              className="grid grid-cols-8 gap-x-8 px-5 py-3 border-b text-sm hover:bg-[#f7f9fd] transition"
            >
            
              <div className="flex flex-col">
                <span className="font-medium">{inv.name}</span>
                <span className="text-xs text-gray-500">Invoice ID: {inv.id}</span>
              </div>
              ...
              <div className="flex justify-end pr-4">
                {inv.status === "Draft" ? (
                  <button
                    className="px-4 py-1.5 rounded-md text-xs cursor-pointer font-semibold flex items-center gap-2 bg-[#50c896] text-white"
                  >

        ...
        <div className="flex items-end mt-8">
          ...
          {currentStep === formSections.length - 1 && (
            <button
              ...
              className="px-8 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed mx-auto"
            >
